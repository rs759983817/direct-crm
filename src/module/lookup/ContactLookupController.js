...
(function () {
    'use strict';
    function ContactLookupController($scope,$rootScope, $state, $ionicActionSheet,rt,LookupService) {
        $scope.pageIndex = 1;
        ...
        function _loadData(success, failure) {
            ...
            LookupService.getContactLookupList($scope.vm.queryValue,$scope.pageIndex,$scope.pageSize)
    ...
    xrmApp.controller("ContactLookupController", ['$scope','$rootScope', '$state', '$ionicActionSheet', 'rt','LookupService',ContactLookupController]);
})();
