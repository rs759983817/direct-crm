...
(function () {
    'use strict';
    function OpportunityLookupController($scope,$rootScope, $state, $ionicActionSheet,rt,LookupService) {
        $scope.pageIndex = 1;
        ...
        function _loadData(success, failure) {
            ...
            LookupService.getOpportunityLookupList($scope.vm.queryValue,$scope.pageIndex,$scope.pageSize)
    ...
    xrmApp.controller("OpportunityLookupController", ['$scope','$rootScope', '$state', '$ionicActionSheet', 'rt','LookupService',OpportunityLookupController]);
})();
